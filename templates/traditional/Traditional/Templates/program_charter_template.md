# Program Charter Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Program Charter Template after its domain migration. The maintained canonical template now resides in the Planning domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Program Charter Template](../../../../domains/planning/templates/traditional/Traditional/Templates/program_charter_template.md)
