# Hybrid Project Charter Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Hybrid Project Charter Template after its domain migration. The maintained canonical template now resides in the Planning domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Hybrid Project Charter Template](../../../../domains/planning/templates/hybrid/Hybrid/Templates/hybrid_project_charter_template.md)
