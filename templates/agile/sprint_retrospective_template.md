# Sprint Retrospective Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Sprint Retrospective Template after its domain migration. The maintained canonical template now resides in the Team domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Sprint Retrospective Template](../../domains/team/templates/agile/sprint_retrospective_template.md)
