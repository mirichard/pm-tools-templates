...
| Project Dashboard Template | `domains/uncertainty/project-lifecycle/04-monitoring-control/progress-tracking/project-dashboard-template.md` | Manual project status | ❌ Schedule/budget/quality only |
