# Operational Qualification (OQ) Protocol Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Operational Qualification (OQ) Protocol Template after its domain migration. The maintained canonical template now resides in the Delivery domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Operational Qualification (OQ) Protocol Template](../../../domains/delivery/industry-specializations/healthcare-pharmaceutical/validation/operational_qualification_protocol_template.md)
