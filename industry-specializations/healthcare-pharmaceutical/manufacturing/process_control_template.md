# Process Control Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Process Control Template after its domain migration. The maintained canonical template now resides in the Delivery domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Process Control Template](../../../domains/delivery/industry-specializations/healthcare-pharmaceutical/manufacturing/process_control_template.md)
