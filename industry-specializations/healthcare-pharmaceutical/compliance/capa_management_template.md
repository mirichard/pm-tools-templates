# Corrective and Preventive Action (CAPA) Management Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Corrective and Preventive Action (CAPA) Management Template after its domain migration. The maintained canonical template now resides in the Delivery domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Corrective and Preventive Action (CAPA) Management Template](../../../domains/delivery/industry-specializations/healthcare-pharmaceutical/compliance/capa_management_template.md)
