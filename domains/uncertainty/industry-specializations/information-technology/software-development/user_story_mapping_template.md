...
- During product discovery or release planning when user activities need a coherent story map.
- When product teams must slice releases around user journeys rather than disconnected features.

## When NOT to Use

- To treat assumed journeys as validated user research.
