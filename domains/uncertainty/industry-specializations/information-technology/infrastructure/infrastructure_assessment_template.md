# Infrastructure Assessment — Compatibility Navigation
...
Follow the link above to view, copy, or update the assessment. Propose content changes at the maintained destination. Keep this navigation file available for existing links from the Migration Plan Template; new catalog entries should reference the maintained resource directly.
