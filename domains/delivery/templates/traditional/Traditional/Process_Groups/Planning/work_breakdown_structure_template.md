...
- During scope planning when deliverables need decomposition into manageable work packages.
- When estimating and scheduling need explicit boundaries, owners, and a WBS dictionary.

## When NOT to Use

- As a task schedule before dependencies and resources have been considered.
...
- [Project Management Plan Template](../../../../../../../domains/delivery/templates/traditional/Traditional/Process_Groups/Planning/project_management_plan_template.md).
