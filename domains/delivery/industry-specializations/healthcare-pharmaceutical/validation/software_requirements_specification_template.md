...
- When regulated software needs traceable intended-use, functional, and control requirements.
- When qualified owners must connect requirements to acceptance and validation evidence.

## When NOT to Use

- To approve regulated use based on a specification without validation evidence.
