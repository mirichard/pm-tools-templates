...
principle_rationale: "Uses planned runs, sampling and statistical evaluation to assess consistent equipment performance under intended routine conditions."
---
...
- When demonstrating consistent performance under intended routine operating conditions.
- When qualified personnel must connect runs, sampling, acceptance, and deviations.

## When NOT to Use

- To substitute successful installation checks for representative performance evidence.
