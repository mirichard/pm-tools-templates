...
- When regulated equipment requires a planned qualification lifecycle.
- When qualified owners need to connect installation, operation, and performance evidence.

## When NOT to Use

- To release equipment for use before applicable qualification and approval activities are complete.
...
- [Installation Qualification Protocol Template](../../../../../domains/delivery/industry-specializations/healthcare-pharmaceutical/validation/installation_qualification_protocol_template.md).
