...
**Generated:** 2025-06-22T20:03:51.558699
...
- **Total Runs Analyzed:** 740

## 🔍 Per-Workflow Performance

| Workflow | Avg Queue Time | Avg Execution Time | Runs |
|----------|----------------|-------------------|------|
| 🏥 Workflow Health Monitor | 0.0 min | 1.78 min | 53 |
| Infrastructure Security Test | 0.0 min | 0.14 min | 25 |
| CodeQL Security Analysis | 0.0 min | 4.56 min | 41 |
| Quality Checks | 0.0 min | 0.38 min | 40 |
| Infrastructure Security Analysis | 0.0 min | 0.15 min | 23 |
| 🎯 Enhanced Template Validation | 0.0 min | 0.17 min | 6 |
| Link Health Check | 0.0 min | 0.35 min | 41 |
| 🔍 Static Application Security Testing (SAST) | 0.0 min | 0.86 min | 44 |
| Anchor Link Check | 0.0 min | 0.3 min | 7 |
...
| pages build and deployment | 0.0 min | 0.51 min | 60 |
...
| .github/workflows/infrastructure-security.yml | 0.0 min | 0.0 min | 16 |
