...
| /basicFlow/steps/1 | functional-suitability | functional-correctness | 0.98 |
...
| /basicFlow/steps/1 | performance-efficiency | capacity | 0.75 |
| /basicFlow/steps/1 | compatibility | interoperability | 0.85 |
| /basicFlow/steps/1 | reliability | faultlessness | 0.9 |
| /basicFlow/steps/1 | reliability | availability | 0.85 |
| /basicFlow/steps/1 | security | confidentiality | 0.98 |
| /basicFlow/steps/1 | security | integrity | 0.95 |
| /basicFlow/steps/1 | security | authenticity | 0.9 |
| /basicFlow/steps/1 | security | resistance | 0.9 |
...
| /alternativeFlows/1/steps/0 | functional-suitability | functional-appropriateness | 0.95 |
| /alternativeFlows/1/steps/0 | interaction-capability | learnability | 0.9 |
| /alternativeFlows/1/steps/0 | interaction-capability | operability | 0.85 |
| /alternativeFlows/1/steps/0 | interaction-capability | user-error-protection | 0.98 |
...
| /exceptionFlows/0/steps/0 | interaction-capability | user-error-protection | 0.95 |
...
| /exceptionFlows/0/steps/0 | reliability | fault-tolerance | 0.85 |
...
Source step: 2; sub-characteristic: functional-correctness; confidence: 0.98.
...
Source step: 2; sub-characteristic: capacity; confidence: 0.75.
...
Source step: 2; sub-characteristic: interoperability; confidence: 0.85.
...
Source step: 2; sub-characteristic: availability; confidence: 0.85.
...
Source step: 2; sub-characteristic: confidentiality; confidence: 0.98.
...
Source step: 2; sub-characteristic: integrity; confidence: 0.95.
...
Source step: 2; sub-characteristic: resistance; confidence: 0.9.
Pattern: core.resistance; library: 0.1.0; taxonomy: 0.1.0.
Metric: success-rate; unit: percent; comparison: &gt;=.
Measurement guidance (not supplied project conditions): Freeze the attack corpus and success oracle; passing does not imply protection from untested attacks.
...
Source step: 4a1; sub-characteristic: functional-appropriateness; confidence: 0.95.
Pattern: core.functional-appropriateness; library: 0.1.0; taxonomy: 0.1.0.
Metric: count; unit: actions; comparison: &lt;=.
Measurement guidance (not supplied project conditions): Count actions from task start to successful goal; report the maximum across the predefined task set.
...
Source step: 4a1; sub-characteristic: learnability; confidence: 0.9.
...
Source step: 4a1; sub-characteristic: operability; confidence: 0.85.
Pattern: core.operability; library: 0.1.0; taxonomy: 0.1.0.
Metric: success-rate; unit: percent; comparison: &gt;=.
Measurement guidance (not supplied project conditions): Use a declared task-success rubric; denominator includes all enrolled participants who attempt the task.
...
Source step: 4a1; sub-characteristic: user-error-protection; confidence: 0.98.
Pattern: core.user-error-protection; library: 0.1.0; taxonomy: 0.1.0.
Metric: success-rate; unit: percent; comparison: &gt;=.
Measurement guidance (not supplied project conditions): Inject the frozen error catalogue; count blocked or safely corrected outcomes over all injected errors.
...
Source step: 4a1; sub-characteristic: resistance; confidence: 0.9.
Pattern: core.resistance; library: 0.1.0; taxonomy: 0.1.0.
Metric: success-rate; unit: percent; comparison: &gt;=.
Measurement guidance (not supplied project conditions): Freeze the attack corpus and success oracle; passing does not imply protection from untested attacks.
...
Source step: 3b1; sub-characteristic: user-error-protection; confidence: 0.95.
Pattern: core.user-error-protection; library: 0.1.0; taxonomy: 0.1.0.
Metric: success-rate; unit: percent; comparison: &gt;=.
Measurement guidance (not supplied project conditions): Inject the frozen error catalogue; count blocked or safely corrected outcomes over all injected errors.
...
Source step: 3b1; sub-characteristic: fault-tolerance; confidence: 0.85.
