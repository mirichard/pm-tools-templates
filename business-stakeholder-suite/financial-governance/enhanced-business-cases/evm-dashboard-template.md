# EVM Dashboard Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the EVM Dashboard Template after its domain migration. The maintained canonical template now resides in the Stakeholder domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the EVM Dashboard Template](../../../domains/stakeholder/business-stakeholder-suite/financial-governance/enhanced-business-cases/evm-dashboard-template.md)
