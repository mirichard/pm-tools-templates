# Advanced Business Case Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Advanced Business Case Template after its domain migration. The maintained canonical template now resides in the Stakeholder domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Advanced Business Case Template](../../../domains/stakeholder/business-stakeholder-suite/financial-governance/enhanced-business-cases/advanced-business-case-template.md)
