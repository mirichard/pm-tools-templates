...
<a id="extractcontents-string-string"></a>
...
<a id="stripcontents-string-string"></a>
...
<a id="parsedocblock-string-key-string-string-string"></a>
### `parse(docblock: string): {[key: string]: string | string[] }`

Parses the pragmas in a docblock string into an object whose keys are the pragma tags and whose values are the arguments to those pragmas.

<a id="parsewithcommentsdocblock-string-comments-string-pragmas-key-string-string-string"></a>
...
<a id="print-comments-string-pragmas-key-string-string-string-string"></a>
