<a id="supertesthttpsladjsgithubiosuperagent"></a>
...
<a id="expectstatus-fn"></a>
### .expect(status[, fn])

Assert response `status` code.

<a id="expectstatus-body-fn"></a>
### .expect(status, body[, fn])

Assert response `status` code and `body`.

<a id="expectbody-fn"></a>
### .expect(body[, fn])

Assert response `body` text with a string, regular expression, or
parsed body object.

<a id="expectfield-value-fn"></a>
### .expect(field, value[, fn])

Assert header `field` `value` with a string or regular expression.

<a id="expectfunctionres"></a>
### .expect(function(res) {})
