<a id="levn-build-statushttpstravis-ciorggkzlevnpnghttpstravis-ciorggkzlevn-a-namelevn"></a>
...
<a id="parsetype-input-options"></a>
### parse(type, input, options)
...
<a id="parsedtypeparseparsedtype-input-options"></a>
### parsedTypeParse(parsedType, input, options)
