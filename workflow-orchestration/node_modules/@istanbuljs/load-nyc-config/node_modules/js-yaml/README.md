...
<a id="safeload-string-options"></a>
...
<a id="safeloadall-string-iterator-options"></a>
...
<a id="loadall-string-iterator-options"></a>
### loadAll (string [, iterator] [ , options ])

Same as `safeLoadAll()` but uses `DEFAULT_FULL_SCHEMA` by default.


<a id="safedump-object-options"></a>
