...
<a id="a-nameparsea-parsetxt-reviver-null-context-20"></a>
...
<a id="a-nameparsea-parsenoexceptionstxt-reviver-null"></a>
#### <a name="parse"></a> `parse.noExceptions(txt, reviver = null)`

Works just like `JSON.parse`, but will return `undefined` rather than
throwing an error.

<a id="a-namejsonparseerrora-class-jsonparseerrorer-text-context-20-caller-null"></a>
