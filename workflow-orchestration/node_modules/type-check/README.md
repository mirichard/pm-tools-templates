<a id="type-check-build-statushttpstravis-ciorggkztype-checkpngbranchmasterhttpstravis-ciorggkztype-check"></a>
...
<a id="typechecktype-input-options"></a>
### typeCheck(type, input, options)
...
```
<a id="parsedtypecheckparsedtype-input-options"></a>
### parsedTypeCheck(parsedType, input, options)
