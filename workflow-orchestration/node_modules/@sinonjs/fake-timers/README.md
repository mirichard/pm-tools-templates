...
<a id="autocomplete-intellisense-and-typescript-definitions"></a>
...
<a id="var-clock-faketimerscreateclocknow-looplimit"></a>
...
<a id="var-clock-faketimersinstallconfig"></a>
...
<a id="var-id-clocksettimeoutcallback-timeout"></a>
...
<a id="clockclearintervalid"></a>
### `clock.clearInterval(id)`

Clears the timer given the ID or timer object, as long as it was created using
`setInterval`.

<a id="var-id-clocksetimmediatecallback"></a>
...
<a id="clockclearimmediateid"></a>
### `clock.clearImmediate(id)`

Clears the timer given the ID or timer object, as long as it was created using
`setImmediate`.

<a id="clockrequestanimationframecallback"></a>
...
<a id="clockcancelanimationframeid"></a>
### `clock.cancelAnimationFrame(id)`

Cancels the callback scheduled by the provided id.

<a id="clockrequestidlecallbackcallback-timeout"></a>
...
<a id="clocknext-await-clocknextasync"></a>
...
<a id="clockrunall-await-clockrunallasync"></a>
...
<a id="clockruntolast-await-clockruntolastasync"></a>
