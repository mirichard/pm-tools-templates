...
Decision: **PASS — integrated; retain B1D on `main`**. Required PR checks and post-merge validation passed.
...
| Reviewed visual regression | PASS — pre-merge run [#378](https://github.com/mirichard/pm-tools-templates/actions/runs/34124382808), attempt 2; post-merge run [#380](https://github.com/mirichard/pm-tools-templates/actions/runs/34126811446), attempt 2 |
...
| Production rollback command | `git revert 074ff132f564afff58e37f7e28dc342e31bbf0e7` |
