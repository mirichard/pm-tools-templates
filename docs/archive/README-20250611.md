...
**[⚖️ Methodology Decision Guide](docs/getting-started/methodology-selector.md)** - Traditional vs Agile vs Hybrid
...
#### 📋 [Traditional/Traditional](Traditional/) - Structured Project Management
**Waterfall, predictive planning, and traditional PMI approaches**
- [Process Groups](Traditional/Process_Groups/) - Initiating, Planning, Executing, Monitoring, Closing
- [Knowledge Areas](Traditional/) - Integration, Scope, Schedule, Cost, Quality, Resource, Communications, Risk, Procurement, Stakeholder
...
3. **[Stakeholder Register](Traditional/Process_Groups/Initiating/stakeholder_register_template.md)** - Stakeholder identification and analysis
...
7. **[Work Breakdown Structure](Traditional/Process_Groups/Planning/work_breakdown_structure_template.md)** - Project decomposition
...
1. **Traditional PM**: [Traditional Process Groups](Traditional/Process_Groups/) → [Waterfall Templates](Waterfall/Templates/)
