...
- **#1:** PMBOK: Core Process Groups Templates
...
- **#12:** Create Remaining PMBOK Process Groups
- **#13:** Create PM templates that integrate with Github projects for Agile, PMBOK and Hybrid methodologies
