...
Use when comparing actual benefit achievement against the approved expected trajectory to identify gaps and corrective actions. This template works best when you have both planned and actual performance data, and need a structured analysis for governance or steering committee reviews.

## When NOT to Use

Do not use as a replacement for real-time benefit tracking or monitoring dashboards. Avoid using this template for benefits that are entirely non-quantifiable or that lack reliable historical baseline data.
