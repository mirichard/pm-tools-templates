...
- risk-optimization
principle_rationale: Protects safety and integrity through quality-by-design and stewardship
  principles.
---
...
Use this template when operational qualification protocol template aligns with your project needs and governance requirements. This template is designed to support your project by providing structure and ensuring key considerations are documented.

## When NOT to Use

Do not use this template if your organization has established alternative processes or standards for this function, or if the level of detail exceeds your project's needs or governance requirements.
