# Traditional Project Charter Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Traditional Project Charter Template after its domain migration. The maintained canonical template now resides in the Planning domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Traditional Project Charter Template](../../../domains/planning/project-lifecycle/01-initiation/project-charter/traditional-project-charter-template.md)
