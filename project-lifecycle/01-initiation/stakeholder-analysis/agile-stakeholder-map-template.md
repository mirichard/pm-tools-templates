# Agile Stakeholder Map Template — Moved

## Purpose and overview

This legacy path is retained so existing repository links and external bookmarks continue to reach the Agile Stakeholder Map Template after its domain migration. The maintained canonical template now resides in the Stakeholder domain; this file contains navigation guidance only and is not a second template copy.

**Canonical location:** [Open the Agile Stakeholder Map Template](../../../domains/stakeholder/project-lifecycle/01-initiation/stakeholder-analysis/agile-stakeholder-map-template.md)
